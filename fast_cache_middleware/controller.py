...
class Controller:
    ...
    ) -> tp.Tuple[tp.Optional["CacheConfig"], tp.Optional["CacheDropConfig"]]:
    ...
    async def should_cache_request(
        self, request: Request, cache_config: tp.Optional["CacheConfig"]
    ) -> bool:
    ...
    async def get_cached_response(
        self, cache_key: str, request: Request, storage: "BaseStorage"
    ...
    async def handle_cache_invalidation(
        self, request: Request, storage: "BaseStorage"
    ) -> None:
